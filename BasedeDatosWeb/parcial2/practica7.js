//this doesnt work and its the same code as the professor u have to be kidding me
function validar(posicion){
    var cuadro = document.getElementById("cuadro"+posicion);
    if(cuadro.value != "x" && cuadro.value != "o"){
        console.log(cuadro.value + "--- nop");
        cuadro.value = '';
        return;
    } else {
        ...
        switch(posicion){
            case 1:
                if(cuadro1 == cuadro2 && cuadro1 == cuadro3){
                    console.log("WE CANT STOP WINNING ::::::" + cuadro1)
                    pintar(1,2,3);
            ...
            case 2:
                if(cuadro2 == cuadro1 && cuadro2 == cuadro3){
                    console.log("WE CANT STOP WINNING ::::::" + cuadro2)
                    pintar(1,2,3);
            ...
            case 3:
                if(cuadro3 == cuadro2 && cuadro3 == cuadro1){
                    console.log("WE CANT STOP WINNING ::::::" + cuadro3)
                    pintar(3,2,1);
            ...
            case 4:
                if(cuadro4 == cuadro1 && cuadro4 == cuadro7){
                    console.log("WE CANT STOP WINNING ::::::" + cuadro4)
                    pintar(4,1,7);
            ...
            case 5:
                if(cuadro5 == cuadro2 && cuadro5 == cuadro8){
                    console.log("WE CANT STOP WINNING ::::::" + cuadro5)
                    pintar(5,2,8);
            ...
            case 6:
                if(cuadro6 == cuadro5 && cuadro6 == cuadro4){
                    console.log("WE CANT STOP WINNING ::::::" + cuadro6)
                    pintar(4,5,6);
            ...
            case 7:
                if(cuadro7 == cuadro4 && cuadro7 == cuadro1){
                    console.log("WE CANT STOP WINNING ::::::" + cuadro7)
                    pintar(1,4,7);
            ...
            case 8:
                if(cuadro8 == cuadro5 && cuadro8 == cuadro2){
                    console.log("WE CANT STOP WINNING ::::::" + cuadro8)
                    pintar(8,5,2);
            ...
            case 9:
                if(cuadro9 == cuadro5 && cuadro9 == cuadro1){
                    console.log("WE CANT STOP WINNING ::::::" + cuadro9)
                    pintar(9,5,1);
...
function pintar(p1, p2, p3){
    document.getElementById("cuadro"+p1).style.backgroundColor = "#f5bcf2";
    document.getElementById("cuadro"+p2).style.backgroundColor = "#f5bcf2";
    document.getElementById("cuadro"+p3).style.backgroundColor = "#f5bcf2";
}
